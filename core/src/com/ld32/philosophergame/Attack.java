...
public class Attack {
	...
	public static Attack Paradox(){
		...
		return new Attack("Paradox", 0, 0, 10, 0, 0, 0.5f, 0, messages);
	}
	...
	public static Attack AdHominem() {
		...
		return new Attack("Ad Hominem", 0, 10, 0, 0, 0, 0, 0, messages);
	}
	...
	public static Attack SelPerption(){
		...
		return new Attack("Selective Perception", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack EternalReturn(){
		...
		return new Attack("Eternal Return", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	public static Attack WilltoPower(){
		...
		return new Attack("Will to Power", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	public static Attack SummonUbermensch(){
		...
		return new Attack("Summon Ubermensch", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack CartesianDualism(){
		...
		return new Attack("Cartesian Dualism", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack DeusDeceptor(){
		...
		return new Attack("Deus Deceptor", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}	
	...
	public static Attack CogitoErgoSum(){
		...
		return new Attack("Cogito Ergo Sum", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}	
	...
	public static Attack SocraticMethod(){
		...
		return new Attack("Socratic Method", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack PlatonicLove(){
		...
		return new Attack("Platonic Love", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}	
	...
	public static Attack AristotelianLogic(){
		...
		return new Attack("Aristotelian Logic", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack Pessimism(){
		...
		return new Attack("Pessimism", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack LifeIsSuffering(){
		...
		return new Attack("Life is Suffering", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	
	public static Attack HedgehogDilemma(){
		String[] messages = new String[3];
		messages[0] = "Real Closeness is impossible."+n+"For hedgehgs I mean.";
		...
		return new Attack("Hedgehog Dilemma", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack LogicalAtomism(){
		...
		return new Attack("Logical Atomism", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack LanguageGames(){
		...
		return new Attack("Language Games", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack BeatleInABox(){
		...
		return new Attack("Beatle in a Box", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack SocialContract(){
		...
		return new Attack("Social Contract", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack AllAgainstAll(){
		...
		return new Attack("All against All", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack SummonLeviathan(){
		...
		return new Attack("Summon Leviathan", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack Tabu(){
		...
		return new Attack("Tabu", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack SexualRepression(){
		...
		return new Attack("Sexual Repression", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack SummonSuperEgo(){
		...
		return new Attack("Summon Superego", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack PureReason(){
		...
		messages[1] = "It is generally assumed that the taboo is older"+n+"than the gods and goes back to the pre-religious age.";
		messages[2] = "The mind should develop a blind spot whenever a dangerous"+n+"thought presented itself. The process should be automatic, instinctive. ";
		return new Attack("Pure Reson", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack CategoricalImperative(){
		...
		return new Attack("Categorical Imperative", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack Enlightenment(){
		...
		return new Attack("Enlightenment", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack Angst(){
		...
		return new Attack("Angst", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack ExistentialDespair(){
		...
		return new Attack("Existential Despair", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
	...
	public static Attack SummonKnightOfFaith(){
		...
		return new Attack("Summon Knight of Faith", 1, 0, 0, 0, 0, 0.5f, 1, messages);
	}
