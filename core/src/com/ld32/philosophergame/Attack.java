...
public class Attack {
	...
	public static Attack Paradox(){
		...
		return new Attack("Paradox", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack AdHominem() {
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Ad Hominem", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack SelPerption(){
		...
		int hpHealing = 5;  int sanityHealing = 5;
		  float malus = 0;        float bonus = 0;
		return new Attack("Selective Perception", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack EternalReturn(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Eternal Return", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	public static Attack WilltoPower(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Will to Power", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	public static Attack SummonUbermensch(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Summon Ubermensch", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack CartesianDualism(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Cartesian Dualism", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack DeusDeceptor(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Deus Deceptor", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}	
	...
	public static Attack CogitoErgoSum(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Cogito Ergo Sum", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}	
	...
	public static Attack SocraticMethod(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Socratic Method", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack PlatonicLove(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Platonic Love", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}	
	...
	public static Attack AristotelianLogic(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Aristotelian Logic", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack Pessimism(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Pessimism", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack LifeIsSuffering(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Life is Suffering", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack HedgehogDilemma(){
		...
		return new Attack("Hedgehog Dilemma", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack LogicalAtomism(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Logical Atomism", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack LanguageGames(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Language Games", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack BeatleInABox(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Beatle in a Box", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack SocialContract(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Social Contract", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack AllAgainstAll(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("All against All", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack SummonLeviathan(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Summon Leviathan", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack Tabu(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Tabu", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack SexualRepression(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Sexual Repression", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack SummonSuperEgo(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Summon Superego", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack PureReason(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Pure Reson", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack CategoricalImperative(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Categorical Imperative", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack Enlightenment(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Enlightenment", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack Angst(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Angst", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack ExistentialDespair(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Existential Despair", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	...
	public static Attack SummonKnightOfFaith(){
		...
		int hpHealing = 0;  int sanityHealing = 0;
		  float malus = 0;        float bonus = 0;
		return new Attack("Summon Knight of Faith", coolDown, hpDamage, sanityDamage, hpHealing, sanityHealing, malus, bonus, messages);
	}
	

	public Attack(String name, int coolDown, int hpDamage, int sanityDamage, int hpHealing, int sanityHealing, float bonus, float malus, String[] messages) {
		this.name = name;
